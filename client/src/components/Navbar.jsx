...
import ubaid from '../assets/images/ubaid1.jpg'
...
const profileMenuItems = [
  ...
  function ProfileMenu() {
    ...
    const closeMenu = () => setIsMenuOpen(false);
     const handleSignOut = () => {
    // Here you can clear any user authentication data if needed
    toast.success("Sign out successfully!"); // Show success message
        ...
        <MenuHandler>
          ...
          >
            <Avatar
              ...
              size="sm"
              alt="tania andrew"
              className="object-cover border border-gray-900"
              src={ubaid}
...
export function NavbarDefault() {
  ...
  return (
    <Navbar className="mx-auto max-w-screen-3xl px-4 py-2 lg:px-8 lg:py-4 bg-gray-300">
